...
Never kill processes by name pattern (`pkill -f`, `killall`) - it kills mine too. Kill only a PID you started, and prefer reusing a dev server that is already running.
