...
*across every layer it touches* - `modules/desktop.nix` carries the compositor's NixOS options, its
overlays, the screencast portal and the `~/.config/mango` symlink together.
